...
export function getScore(){
  ...
  openDataContext.postMessage({
    text: 'getScore',
    openId: _globalData.userInfo.openId,
  })
}
...
export function openTunnel() {
  ...
  tunnel.on('people', msg => {
    if (msg.online) {
      ...
      _globalData.userInfo = msg.who

      if (_globalData.userInfo.openId != undefined) {
        console.log('用户', _globalData.userInfo.nickName, ' id:', _globalData.userInfo.openId)

        getScore()

      }
      if (msg.who.openId != _globalData.userInfo.openId) {
